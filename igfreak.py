...
try:
	...
	import requests,socksexcept Exception:
...
{Fore.MAGENTA}IgFreak , Slick Instagram brute force command line tool. Copyright (C) 2021 , Aryan-Mfc
...
{G}For more information visit {B}https://github.com/RedHackkErR/IgFreak
