...
echo -e '\e[93m               
          ...
          XX       |##/~~\####%;;;/~~\;,|       XX
        XX..X      |#|  o  \##%;/  o  |.|      X..XX
      XX.....X     # A tool by nitro from www.noob-hackers.com
# Be a unique person not copy cat
# Colours
#-----------------
red="\e[91m"
...
echo 
# Functions
echo -e "$red                    [devilvirusmaker them with fun]$rset"
echo " "
echo " "
}
baner1(){
...
echo " "
echo " "
echo -e "$red                        ➡$cyan [\e[92m1\e[96m] devilvirusmaker now"
...
upd(){
if [ -d "$HOME/devilvirusmaker" ];
then
cd $HOME
rm -rf devilvirusmaker
elif [ -d "$HOME/devilvirusmaker" ];
then
cd $HOME
rm -rf devilvirusmaker
else
...
while git clone https://github.com/noob-hackers/devilvirusmaker 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
...
cd $HOME
cd devilvirusmaker
bash devilvirusmaker.sh
}
vid(){
FILE=$HOME/devilvirusmaker/noob.noob
if [ -f "$FILE" ]; then
pop
else
echo
